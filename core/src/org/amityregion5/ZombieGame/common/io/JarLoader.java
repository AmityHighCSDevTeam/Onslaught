...
public class JarLoader {
	 ...
	 *
	 * @param parent
	 *            the parent file to search through
	 * @param searchJars
	 *            should it search inside jars and zips
	 * @throws FileNotFoundException
	 *             thrown when the file sent doesn't exsist or isn't a directory
	 */
	public JarLoader(File jar) throws FileNotFoundException {
		if (!jar.exists()) { throw new FileNotFoundException("File does not exist"); }
		this.jar = jar;
	}
