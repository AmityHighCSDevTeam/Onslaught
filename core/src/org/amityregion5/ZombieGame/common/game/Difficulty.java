...
public enum Difficulty {
	...
	/**
	 * 
	 * @return a version of Difficulty.values() that has been sorted by difficulty
	 */
	public static Difficulty[] getSortedArray() {
		...
		Arrays.parallelSort(result, new Comparator<Difficulty>() {
			@Override
			public int compare(Difficulty o1, Difficulty o2) {
				return (int) ((100 * o1.difficultyMultiplier) - (100 * o2.difficultyMultiplier));
			}		
		});
