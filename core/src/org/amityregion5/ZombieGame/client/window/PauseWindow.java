...
public class PauseWindow implements Screen {
	...
	private void drawMain(float delta){
		...
		boolean mouseOverQuit = Gdx.input.getX() > screen.getWidth()/2-200 && Gdx.input.getX() < screen.getWidth()/2 && screen.getHeight() - Gdx.input.getY() > screen.getHeight()/2-100 && screen.getHeight() - Gdx.input.getY() < screen.getHeight()/2-50;
		
		glyph.setText(ZombieGame.instance.mainFont, "Quit", (mouseOverQuit ? new Color(27/255f, 168/255f, 55/255f, 1f) : Color.WHITE), 180, Align.center, false);
		...
		boolean mouseOverSave = Gdx.input.getX() > screen.getWidth()/2 && Gdx.input.getX() < screen.getWidth()/2+200 && screen.getHeight() - Gdx.input.getY() > screen.getHeight()/2-100 && screen.getHeight() - Gdx.input.getY() < screen.getHeight()/2-50;
		
		glyph.setText(ZombieGame.instance.mainFont, "Save and Quit", (mouseOverSave ? new Color(27/255f, 168/255f, 55/255f, 1f) : Color.WHITE), 180, Align.center, false);
