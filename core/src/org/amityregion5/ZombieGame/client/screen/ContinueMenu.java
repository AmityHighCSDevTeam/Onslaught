...
public class ContinueMenu extends GuiScreen {
	...
	protected void drawScreen(float delta) {
		...
		// Draw name of screen
		calibri30.draw(batch, "Continue", 10, getHeight() - 45,
	...
	protected void setUpScreen() {
		...
		addButton(new GuiButton(ZombieGame.instance.buttonTexture, -1, "Back",
				10, 10, getWidth()/2 - 20, 50));
		addButton(new GuiButton(ZombieGame.instance.buttonTexture, -2, "Load",
				getWidth()/2+10, 10, getWidth()/2 - 20, 50));
	}
