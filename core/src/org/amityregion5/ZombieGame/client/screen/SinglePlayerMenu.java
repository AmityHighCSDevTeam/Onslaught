...
public class SinglePlayerMenu extends GuiScreen {
	...
	protected void drawScreen(float delta) {
		...
		//Draw name of screen
		calibri30.drawWrapped(batch, "Singleplayer", 10, getHeight() - 45, getWidth() - 20, HAlignment.CENTER);
	}
	...
	protected void setUpScreen() {
		...
		//Register buttons
		addButton(new GuiButton(ZombieGame.instance.buttonTexture, 0, "New Game", 10, getHeight() - 150, getWidth() - 20, 50));
		addButton(new GuiButton(ZombieGame.instance.buttonTexture, 1, "Continue", 10, getHeight() - 210, getWidth() - 20, 50).setEnabled(false));
